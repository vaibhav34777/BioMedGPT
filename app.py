...
# Assume you have uploaded your model checkpoint to Hugging Face under a repo, e.g., "your_username/biomedgpt"
# The checkpoint file is assumed to be named "checkpoint_step1050.pt"

checkpoint_path = hf_hub_download(repo_id="your_username/biomedgpt", filename="checkpoint_step1050.pt")
